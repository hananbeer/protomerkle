...
import "../src/CachedMerkleTree.sol";

contract CachedMerkleTests is Test, MerkleTestUtils {
    CachedMerkleTree public merkle;

    constructor() MerkleTestUtils(4, 32) {
    }

    function setUp() public {
        merkle = new CachedMerkleTree(uint8(TREE_HEIGHT), uint16(ITEM_SIZE));
    }
    ...
    function testCachedStressTestTree() public {
        updateNode(0, 1);
        updateNode(1, 2);
        updateNode(1, 3);
    ...
    function testCachedManaBatch() public {
        uint256 count = 3;
